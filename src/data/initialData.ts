...
export const initialSiteSettings: SiteSettings = {
  ...
  siteLogoUrl: "/images/logo_lbh_ansor_official.svg",
  heroBannerUrl: "https://images.unsplash.com/photo-1453733197781-e0de24707c66?w=1600&auto=format&fit=crop&q=80",
  centerpieceLogoUrl: "/images/logo_lbh_ansor_official.svg",
  centerpieceBadge: "⚖️ FIAT JUSTITIA RUAT CAELUM",
  centerpieceMotto: '"Tegakkan Keadilan Walau Langit Akan Runtuh"',
  centerpieceSubheading: "Khidmah Penegakan Hukum & Advokasi Kerakyatan",
  ...
  pillar1Title: "Bebas Biaya (Pro Bono)",
  pillar1Desc: "Khidmah perbantuan hukum tanpa pungutan biaya bagi kaum mustadh'afin, buruh, petani, dan warga tidak mampu.",
  pillar2Title: "Advokat Tersumpah",
  pillar2Desc: "Didukung puluhan advokat berpengalaman dan paralegal militan Ansor di 8 Kabupaten & Kota se-Provinsi Banten.",
  pillar3Title: "Notifikasi WhatsApp",
  pillar3Desc: "Sistem pembaruan status perkara otomatis langsung ke WhatsApp pemohon secara transparan dan akuntabel.",
  pillar4Title: "Tanya ABI (Asisten Pintar)",
  pillar4Desc: "Tanya jawab instan 24 jam dengan asisten cerdas LBH Ansor Banten berbasis hukum positif dan wawasan umum.",
  ctaHeading: "Jangan Hadapi Masalah Hukum Anda Sendirian",
  ctaSubheading: "LBH GP Ansor Banten hadir untuk memastikan keadilan tegak bagi seluruh lapisan masyarakat. Konsultasikan perkara Anda sekarang tanpa rasa cemas.",
  ctaButtonText: "Ajukan Konsultasi Online Sekarang",
  orgSectionTitle: "Struktur Organisasi",
  orgSectionSubtitle: "Pimpinan Wilayah Lembaga Bantuan Hukum Gerakan Pemuda Ansor Provinsi Banten masa khidmah yang berdedikasi mengawal keadilan bagi seluruh rakyat Banten.",
